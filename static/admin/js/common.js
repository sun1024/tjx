            ...
            if(data.state==200){
              if(data.data){
                ...
                function editSuc(layero, index, data){
                  ...
                  var url =  'http://58.144.34.96:5001/web_manager/public/index.php/index/Data/editPeople';
                ...
                function addSuc(layero, index){
                  ...
                  // ]
                  var addData = aaa;
                  var url =  'http://58.144.34.96:5001/web_manager/public/index.php/index/Data/addPeopleData';
                  iframe.getFromParent(addData,url);
                }
                var addUrl = './alert/sdlr.html';
                var editUrl = './alert/edit.html';
                var editAjaxUrl =  'http://58.144.34.96:5001/web_manager/public/index.php/index/Data/editPeople';
                var detailUrl = './alert/detail.html';
                var deleteUrl = 'http://58.144.34.96:5001/web_manager/public/index.php/index/Data/deletePeopleData';
                var setT = function() {
                  setTable({
                    addUrl: addUrl,
                    editUrl: editUrl,
